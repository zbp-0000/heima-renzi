  ...
  <div id="myPrint" class="dashboard-container">
    <div class="app-container">
      <el-card>
        ...
        <el-row type="fiex" justify="end">
          <el-button v-print="'#tableBox'" type="primary" size="small">打印</el-button>
        </el-row>
        <div v-if="type === 'personal'" id="tableBox">
...
export default {
  ...
  methods: {
    ...
    async getJobDetail() {
      const userInfo = await getEmplyeeBaseInfo(this.userId)
